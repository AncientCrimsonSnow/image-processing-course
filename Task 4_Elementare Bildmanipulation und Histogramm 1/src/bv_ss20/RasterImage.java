...
public class RasterImage {
	...
	public void convertToGray() {
		...
		for(int i = 0; i < argb.length; i++) {
			...
			argb[i] = (0xFF<<24) | (currentPixel_RGB.getR()<<16) | (currentPixel_RGB.getG()<<8) | currentPixel_RGB.getB();
		}
	}
	...
	public void applyToneCurve(ToneCurve curve) {
		...
		for(int i = 0; i< argb.length;i++) {
			...
			currentPixel_RGB.setR(curve.mappedGray(currentPixel_RGB.getR()));
			currentPixel_RGB.setG(curve.mappedGray(currentPixel_RGB.getG()));
			currentPixel_RGB.setB(curve.mappedGray(currentPixel_RGB.getB()));
