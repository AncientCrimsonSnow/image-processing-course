...
public class ImageAnalysisAppController {
    ...
    void autoContrast() {
    	...
    	double[] brightness_x_contrast = histogram.autoKontrastCalc(img);
    	brightnessSlider.setValue(brightness_x_contrast[0]);
    	brightness = (int)brightness_x_contrast[0];
    	brightnessChanged();
    	contrastSlider.setValue(brightness_x_contrast[1]);
    	contrast = brightness_x_contrast[1];
    	contrastChanged();
    }
